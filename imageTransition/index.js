//Fork on https://codepen.io/zadvorsky/pen/PNXbGo
...
function init() {
  ...
  l1.load(
    ...
    'https://static.ioliu.cn/bing/Wintersolstice1222_ZH-CN10807868228_1920x1080.jpg',
    function(img) {
      slide.setImage(img);
    }
  );
  ...
  l2.load(
    ...
    'https://static.ioliu.cn/bing/ReindeerLichen_EN-AU9289253828_1920x1080.jpg',
    function(img) {
      slide2.setImage(img);
    }
  );
